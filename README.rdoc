Mini app para probar la creación de un sistema de usuarios con Devise, y que cada usuario pueda formarse una relación familiar
...
- El mismo usuario se puede registrar a si mismo como padre y como madre a la vez o sólo uno de ellos dos.
